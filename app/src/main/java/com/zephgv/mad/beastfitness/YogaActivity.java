    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cd1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gotoUri("https://www.youtube.com/watch?v=A-2d04ON9hA");
            }
        });
        ...
        cd2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(YogaActivity.this, "Opening Youtube!", Toast.LENGTH_SHORT).show();
                gotoUri("https://www.youtube.com/watch?v=orGvMehBDQs");
            }
        });
        ...
        cd3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(YogaActivity.this, "Opening Youtube!", Toast.LENGTH_SHORT).show();
                gotoUri("https://www.youtube.com/watch?v=peFf_eCxnco");
            }
        });
        ...
        cd4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(YogaActivity.this, "Opening Youtube!", Toast.LENGTH_SHORT).show();
                gotoUri("https://www.youtube.com/watch?v=WOw55qnKBSo");
            }
        });
        ...
        cd5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(YogaActivity.this, "Opening Youtube!", Toast.LENGTH_SHORT).show();
                gotoUri("https://www.youtube.com/watch?v=Av9JEU3HiZs");
            }
        });
